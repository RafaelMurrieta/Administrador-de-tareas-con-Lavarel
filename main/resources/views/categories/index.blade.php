        ...
        <form action="{{ route('categories.store') }}" method="POST">
          ...
          <div>
            @foreach ($categories as $category)
              ...
              <div class="modal fade" id="modal-{{ $category->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      Al eliminar la categoria <strong>{{ $category->name }}</strong> se eliminaran todas las tareas qe esta dentro de esta.
                      ¿Está seguro de borrar la categoria <strong>{{ $category->name }}</strong>?
                    </div>
